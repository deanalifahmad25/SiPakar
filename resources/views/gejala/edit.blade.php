    ...
    <section class="p-3">
        <div class="information d-flex flex-column gap-5">
            <div class="row px-1">
                <h5>Data Penyakit</h5>
                <div class="wrapper">
                    <form method="post" action="{{ route('admin.update.data-gejala', $gejala->id) }}" class="mt-6 space-y-6" enctype="multipart/form-data">
                        @csrf
                        @method('put')

                        <div>
                            <x-input-label for="nama_gejala" :value="__('Nama Gejala')" />
                            <x-text-input id="nama_gejala" name="nama_gejala" type="text" class="mt-1 block w-full" value="{{ isset($gejala) ? $gejala->nama_gejala : '' }}"
                        ...
                        <div>
                            ...
                            <x-text-input id="deskripsi_gejala" name="deskripsi_gejala" type="text" class="mt-1 block w-full" value="{{ isset($gejala) ? $gejala->deskripsi_gejala : '' }}"
                        ...
                        <div>
                            ...
                            <x-text-input id="pertanyaan" name="pertanyaan" type="text" class="mt-1 block w-full" value="{{ isset($gejala) ? $gejala->pertanyaan : '' }}"

    ...
    <div class="content-3-5 d-flex flex-column align-items-center h-100 flex-lg-row"
        ...
        <div class="d-flex mx-auto align-items-left justify-content-left width-right mx-lg-0">
            <div class="right mx-lg-0 mx-auto">
                ...
                <h3 class="title-text">Selamat Datang Kembali!</h3>
                <p class="caption-text">
                    Silakan masuk dengan akun yang telah terdaftar<br />
                    untuk melakukan diagnosa.
                </p>

                <form method="POST" action="{{ route('login') }}" style="margin-top: 1.5rem">
                    @csrf
                ...
                <p class="text-center bottom-caption">
                    Belum punya akun? <a href="{{ route('register') }}" class="green-bottom-caption">Daftar disini</a>
                </p>
            </div>
        </div>
    </div>

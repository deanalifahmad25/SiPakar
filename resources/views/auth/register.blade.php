<x-guest-layout>
    ...
    <div class="content-3-5 d-flex flex-column align-items-center h-100 flex-lg-row"
        ...
        <div class="position-relative d-none d-lg-block h-100 width-left">
            <img class="position-absolute img-fluid centered" src="{{ asset('./assets/images/left-image.png') }}" alt="" />
        </div>
        ...
        <div class="d-flex mx-auto align-items-left justify-content-left width-right mx-lg-0">
            <div class="right mx-lg-0 mx-auto">
                <div class="align-items-center justify-content-center d-lg-none d-flex">
                    <img class="img-fluid"src="{{ asset('./assets/images/left-image.png') }}" alt="" />
                </div>

                <h3 class="title-text">Buat Akun SiPakar</h3>
                <p class="caption-text">
                    Daftar sekarang dan dapatkan akses penuh untuk<br />
                    melakukan diagnosa pada website kami.
                </p>
                ...
                <form method="POST" action="{{ route('register') }}" style="margin-top: 1.5rem">
                    ...
                    <div style="margin-top: 1rem">
                        ...
                        <div class="d-flex w-100 div-input">
                            ...
                            <input class="input-field border-0" type="password" name="password_confirmation" id="password"
                                minlength="6" required />
                            <div onclick="togglePassword()">
                                <svg style="margin-left: 0.75rem; cursor: pointer" width="20" height="14"
                                    viewBox="0 0 20 14" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <p class="text-center bottom-caption">
                    Sudah punya akun? <a href="{{ route('login') }}" class="green-bottom-caption">Login disini</a>
                </p>
            </div>
        </div>
    </div>

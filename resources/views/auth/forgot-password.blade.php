...
<body>
    ...
    <section class="h-100 w-100 row" style="box-sizing: border-box; background-color: #FAFCFF;">
        <div class="col-md-6 offset-md-3 align-self-center w-full sm:max-w-md mt-6 px-6 py-4 bg-white shadow-md overflow-hidden sm:rounded-lg">

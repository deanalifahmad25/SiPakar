    ...
    <section class="p-3">
        <div class="information d-flex flex-column gap-5">
            <div class="row px-1">
                <h5>Data Penyakit</h5>
                <div class="wrapper">
                    <form method="post" action="{{ route('admin.store.data-penyakit') }}" class="mt-6 space-y-6" enctype="multipart/form-data">
                        @csrf

                        <div>
                            <x-input-label for="nama_penyakit" :value="__('Nama Penyakit')" />
                            <x-text-input id="nama_penyakit" name="nama_penyakit" type="text" class="mt-1 block w-full"
                        ...
                        <div>
                            ...
                            <x-text-input id="deskripsi_penyakit" name="deskripsi_penyakit" type="text" class="mt-1 block w-full"
                        ...
                        <div>
                            ...
                            <x-text-input id="solusi_penyakit" name="solusi_penyakit" type="text" class="mt-1 block w-full"
